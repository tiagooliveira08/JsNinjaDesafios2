...
*/
  ...
  console.log(
    text.replace(/Manuel Marques de Sousa/g, "Tiago alves de Oliveira")
  );
...
*/
  ...
  console.log(text.replace(/brasileiro/gi, "Soterapolitano"));
...
*/
  ...
  console.log(
    text.replace(/O Centauro de Luvas/g, function() {
...
*/
  ...
  function getMonthNumber(month) {
    var monthUpperCase = month.charAt(0).toUpperCase() + month.slice(1);
