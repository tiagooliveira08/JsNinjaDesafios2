...
para o contrário.
*/
var isTruthy = function(isTruthy) {
	return !!isTruthy;
}
...
console.log(isTruthy({}));
console.log(isTruthy([]));
console.log(isTruthy("dadsa"));
console.log(isTruthy('dadasd'));
console.log(isTruthy(true));
console.log(isTruthy(test));
console.log(isTruthy(!false));
console.log(isTruthy(!undefined));
console.log(isTruthy(function test() {}));
...
*/
carro.adicionarPessoasAoCarro = function(pessoas) {
...
console.log("Mude a cor do carro para vermelho");
console.log(carro.mudarCor("Preto"));

// E agora, qual a cor do carro//?
console.log("E agora, qual a cor do carro?");
console.log(carro.cor);


console.log("Mude a cor do carro para verde musgo.")
...
console.log(carro.adicionarPessoasAoCarro(5));
